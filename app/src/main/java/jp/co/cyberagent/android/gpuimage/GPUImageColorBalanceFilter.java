...
public class GPUImageColorBalanceFilter extends GPUImageFilter {
    ...
    private float[] highlights = new float[]{0.0f, 0.0f, 0.0f};
    ...
    private float[] midtones = new float[]{0.0f, 0.0f, 0.0f};
    private boolean preserveLuminosity = true;
    private float[] showdows = new float[]{0.0f, 0.0f, 0.0f};
