...
public class HorizontalListView extends AdapterView<ListAdapter> {
    ...
    private DataSetObserver mDataObserver = new C14711();
    private int mDisplayOffset = 0;
    private GestureDetector mGesture;
    private int mLeftViewIndex = -1;
    private int mMaxX = Integer.MAX_VALUE;
    protected int mNextX;
    private OnGestureListener mOnGesture = new C14733();
    ...
    /* renamed from: com.irisstudio.demo.view.HorizontalListView$1 */
    class C14711 extends DataSetObserver {
        C14711() {
        }
    ...
    /* renamed from: com.irisstudio.demo.view.HorizontalListView$2 */
    class C14722 implements Runnable {
        C14722() {
        }
    ...
    /* renamed from: com.irisstudio.demo.view.HorizontalListView$3 */
    class C14733 extends SimpleOnGestureListener {
        C14733() {
        }
